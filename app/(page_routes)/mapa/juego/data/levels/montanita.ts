...
export const platforms: PlatformData[] = [
  ...
  { id: 'p3',  position: [11.5, 6.6, 0], size: [2.8, 0.85, 1.9], kind: 'rock'  },
  ...
  { id: 'p8',  position: [29.0, 10.6, 0], size: [2.5, 0.85, 1.8], kind: 'rock'  },
...
export const enemies: EnemyData[] = [
  ...
  { id: 'e2', position: [15.5, 9.05, 0], patrolRange: 1.2 },
  { id: 'e3', position: [20.5, 10.45, 0], patrolRange: 1.3 },
  { id: 'e4', position: [26.5, 11.25, 0], patrolRange: 1.4 }, // antes de la cima
  { id: 'e5', position: [37.0, 13.95, 0], patrolRange: 1.6 }, // Guardián de la cima
  { id: 'e6', position: [46.5, 9.95,  0], patrolRange: 1.4 },
  { id: 'e7', position: [54.5, 7.0,   0], patrolRange: 1.5 },
  { id: 'e8', position: [61.5, 2.45,  0], patrolRange: 1.3 },
  { id: 'e9', position: [67.5, -1.15, 0], patrolRange: 1.4 },
];
