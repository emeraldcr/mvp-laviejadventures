...
import type { BookingRecord, SuccessPageProps } from "@/lib/types/index";
...
// ---------- EMAIL (uses shared booking-emails module) ----------
...
export default async function SuccessPage({ searchParams }: SuccessPageProps) {
  ...
  await Promise.allSettled([
    // 1. Branded confirmation email → customer
    email
      ? sendCustomerConfirmationEmail({
          to: email,
          name,
