  ...
  return (
    <div>
      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        {/* Welcome card */}
        <div className="mb-8 rounded-2xl bg-gradient-to-br from-emerald-600 to-emerald-700 p-6 text-white shadow-lg">
          <p className="text-emerald-200 text-sm font-medium">Bienvenido de vuelta,</p>
          <h1 className="mt-1 text-2xl font-bold">{operator.name}</h1>
          <p className="text-emerald-200 mt-0.5">{operator.company}</p>
