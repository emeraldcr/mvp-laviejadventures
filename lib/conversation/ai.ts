...
const INTERPRETATION_SCHEMA = {
  ...
  properties: {
    ...
    fields: {
      ...
      properties: {
        tour: { type: ["string", "null"], enum: ["tour-ciudad-esmeralda", "cascadas-secretas-rio-la-vieja", "caminata-volcanes-dormidos", null] },
...
- Para preguntas, use exclusivamente las FAQ verificadas incluidas abajo.
- Si las FAQ no respaldan la respuesta, indique brevemente que el equipo debe confirmarla.
